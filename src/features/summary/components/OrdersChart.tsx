    ...
    <div className='bg-white rounded-lg shadow-md p-6'>
      <div className='flex items-center gap-3 mb-6'>
        <div className='p-2 bg-purple-100 rounded-lg'>
          <BsReceipt className='text-xl text-purple-600' />
        </div>
        <div>
          <h2 className='text-lg font-bold text-gray-800'>Order Volume</h2>
          <p className='text-sm text-gray-600'>Daily order counts across branches</p>
        </div>
      </div>
